...
function withTimeout(promise) {
  ...
  var msgOnTimeout = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'operation timed out!';
...
var User = function () {
  ...
  _createClass(User, [{
    ...
    value: function getHtzTmUserType(userProducts, productType) {
      ...
      if (this.userHasProduct(userProducts, productType, true) || this.userHasProduct(userProducts, productTypes.htz_tm, true)) {
        return userTypes.trial;
      }
      return userTypes.registered;
    }
    ...
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return withTimeout(window.fetch('/ssoGroupKey?value=' + this.user.sso.userId, {
                  method: 'GET',
                  cache: false
                }));
              ...
              case 6:
                ...
                if (response && response.result && response.result !== 'item not found' && response.result !== 'value is empty') {
              ...
              case 13:
                return _context.abrupt('return', groupKey);
      ...
      function getSsoGroupKey() {
        return _ref.apply(this, arguments);
      }

      return getSsoGroupKey;
    }()
  }]);
          ...
          return _regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return this.initGoogleTargetingParams();
    ...
    */
    ...
    value: function () {
      var _ref2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2() {
        var ssoGroupByKey, pubads, anonymousIdKeyName;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                ssoGroupByKey = null; // await this.user.getSsoGroupKey();
                ...
                if (this.config.anonymousId) {
                  anonymousIdKeyName = 'anonymousIdKey';
      ...
      function initGoogleTargetingParams() {
        return _ref2.apply(this, arguments);
      }

      return initGoogleTargetingParams;
    }()
