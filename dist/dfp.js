...
(function (global, factory) {
  ...
  var ImpressionsManager = function () {
    function ImpressionsManager(impressionManagerConfig) {
      ...
      var interval = window.setTimeout(function () {
        try {
          _this.saveImpressionsToLocalStorage();
        } catch (err) {
    ...
    babelHelpers.createClass(ImpressionsManager, [{
      ...
      value: function retrieveImpressionsData() {
        ...
        Object.keys(impressions).map(function (key, index) {
          impressions[key] = Object.assign({}, impressions[key], _this2.config[key]);
        });
        ...
        try {
          ...
          oldImpressionsArray.forEach(function (impression) {
            try {
              ...
              var expires = parseInt(data.split('/')[1]) || _this3.now;
              impressions[id] = {};
  ...
  var AdManager = function () {
    function AdManager(config) {
      ...
      try {
        googletag.cmd.push(function () {
          _this.initGoogleTargetingParams();
          _this.initSlotRenderedCallback();
        });
        // Holds adSlot objects as soon as possible.
        googletag.cmd.push(function () {
          _this.adSlots = _this.initAdSlots(config.adSlotConfig);
        });
        // Once DOM ready, add the rest of the adSlots.
        document.addEventListener('DOMContentLoaded', function () {
          googletag.cmd.push(function () {
            _this.adSlots = _this.initAdSlots(config.adSlotConfig);
            _this.initGoogleGlobalSettings();
          });
        });
      } catch (err) {
        console.log(err);
    ...
    babelHelpers.createClass(AdManager, [{
      ...
      key: 'initAdSlots',
      value: function initAdSlots(adSlotConfig) {
        var _this2 = this;
        ...
        adSlotPlaceholders = adSlotPlaceholders.sort(function (a, b) {
