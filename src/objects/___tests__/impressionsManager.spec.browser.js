...
import { keys } from '../../objects/impressionsManager';
...
describe( 'impressionsManager', () => {
  ...
  describe(` with a new user `, () => {
    ...
    describe( 'impressionsManager.impressions', () => {
      ...
      Object.keys( impressionManagerConfig ).map(function(key, index) {
    ...
    describe( 'impressionsManager.reachedQuota', () => {
      ...
      Object.keys( impressionManagerConfig ).map(function(key, index) {
        it( `should return a boolean for any adSlotId given. adSlotId: ${key}`, () => {
    ...
    describe( 'impressionsManager.registerImpression', () => {
      ...
      Object.keys( impressionManagerConfig ).map(function(key, index) {
        it( `should return a boolean for any attempt to register an impression. adSlotId: ${key}`,
          () => {
