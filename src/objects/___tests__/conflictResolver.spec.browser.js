...
describe( 'conflictResolver', () => {
  ...
  describe(`updateResolvedSlot`, () => {
    ...
    it(`should not throw an error when called with an undefined node`,
      () => {
        expect( () => conflictResolver.updateResolvedSlot('haaretz.co.il.web.halfpage.floating_x',[970,250]))
          .to.not.throw(Error);
      } );
  ...
  describe(`isBlocking`, () => {
    ...
    it( `should not throw an error when called with a parameter`, () => {
      expect( () => { conflictResolver.isBlocking('haaretz.co.il.web.plazma') } ).to.not.throw(Error);
    } );
